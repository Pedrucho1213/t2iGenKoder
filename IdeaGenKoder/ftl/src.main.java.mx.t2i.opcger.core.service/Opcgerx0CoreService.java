package mx.t2i.sabe.opcger.core.service;
 ...
 */
@Service
public class Opcgerx0CoreService 
{
	private static final boolean isTraceable = LogBackUtil.addClassToTrace(Opcgerx0CoreService.class);

    private static final Logger log                         = LoggerFactory.getLogger(Opcgerx0CoreService.class);
    ...
    public static final String  CORE_PROGRAM                = "OPCGERZ0"; // Es el programa de enlace, no el de proceso 
...
///            LogTools.logError(log, ex, msg);
    ...
    public List<Opcgerx0VO> getCoreList(final Opcgerx0 coreModel) throws ServiceException {

        Map<String, String> inputFields = coreModel.auxGetSearchFields();

        List<Opcgerx0VO> list = new ArrayList<>();
