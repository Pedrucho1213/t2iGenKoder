...
/**
 * <h4>Description:</h4> Model para interfaz de webservice de ${FTL_Model}
 *
 *
 */
@XmlType(propOrder = {
...
<#list FTL_fieldAttributes as FTL_fieldAttribute>
    <#if  FTL_fieldAttribute.javaType?contains("List")>@XmlElement(name="${FTL_fieldAttribute.javaName}") // Este nombre aparece en el request por cada item y dice <!--Zero or more repetitions:--> 
</#if>
