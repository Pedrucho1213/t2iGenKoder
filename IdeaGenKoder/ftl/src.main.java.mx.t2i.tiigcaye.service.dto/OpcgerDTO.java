package mx.t2i.tiigcaye.service.dto;
...
public class OpcgerDTO implements Serializable {
    ...
    private CatramosDTO catramosDTO;
...
///    @NotNull
	...
	public CatramosDTO getCatramos() {
        return catramosDTO;
    }

    public void setCatramos(CatramosDTO catramos) {
        this.catramosDTO = catramos;
    }
