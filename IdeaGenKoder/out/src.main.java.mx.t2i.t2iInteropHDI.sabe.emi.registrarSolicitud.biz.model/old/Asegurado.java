...
@Component
public class Asegurado extends mx.t2i.tekhne.core.model.RootObject {
	...
	@Autowired
	private List<Cobertura> coberturas = null;
    ...
    @XmlElement(name="coberturas") // Este nombre aparece en el request por cada item y dice <!--Zero or more repetitions:--> 
