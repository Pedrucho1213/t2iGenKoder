...
import mx.t2i.t2iInteropHDI.sabe.emi.registrarSolicitud.core.model.Asegplz4;
...
/**
 * Despachador (Dispatcher) del servicio para Asegplz4CoreService
 */
@Service
public class Asegplz4CoreService {
	private static final Logger log = LoggerFactory.getLogger(Asegplz4CoreService.class);
	...
	public static final String CORE_PROGRAM = "ASEGPLZ4"; // Es el programa de enlace, no el de proceso
	 ...
	 * Constructor default
	 */
	public Asegplz4CoreService() {
		super();
	}

	public void getCore(Asegplz4 coreModel) throws ServiceException {
	...
	public List<Asegplz4> getCoreList(final Asegplz4 coreModel) throws ServiceException {

		Map<String, String> inputFields = coreModel.auxGetSearchFields();

		List<Asegplz4> list = new ArrayList<>();
	...
	public void insertCore(Asegplz4 coreModel) throws ServiceException {
		// Preparar input fields
	...
	public void updateCore(Asegplz4 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetTransactionFields();
	...
	public void deleteCore(Asegplz4 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetSearchFields();
	...
	public void previousCore(Asegplz4 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetSearchFields();
	 ...
	 */
	protected void coreDao_get(Map<String, String> inputFields, Asegplz4 coreModel)
...
//        coreModel.setUsuario(coreResponse.get("usuario")); // 2021-02-25 ati: No viene definido  
	...
	protected List<Asegplz4> coreDao_getList(Map<String, String> inputFields, Asegplz4 coreModel)
			throws ObjectRetrievalFailureException, Exception {
		...
		List<Asegplz4> list = Asegplz4.auxGetListFromCore(coreResponse);
	...
	protected void coreDao_insert(Map<String, String> inputFields, Asegplz4 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_update(Map<String, String> inputFields, Asegplz4 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_delete(Map<String, String> inputFields, Asegplz4 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_previous(Map<String, String> inputFields, Asegplz4 coreModel)
			throws ObjectRetrievalFailureException, Exception {
		Map<String, String> coreResponse = coreDaoSabe.execute(CORE_SYSTEM, CORE_PROGRAM, CORE_PROGRAM_VERSION,
