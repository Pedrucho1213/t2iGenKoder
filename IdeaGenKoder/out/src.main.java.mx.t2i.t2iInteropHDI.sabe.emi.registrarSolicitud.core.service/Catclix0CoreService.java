...
/**
 * Despachador (Dispatcher) del servicio para Catclix0CoreService
 */
@Service
public class Catclix0CoreService {
	private static final Logger log = LoggerFactory.getLogger(Catclix0CoreService.class);
	...
	public static final String CORE_PROGRAM = "CATCLIZ0"; // Es el programa de enlace, no el de proceso
	 ...
	 * Constructor default
	 */
	public Catclix0CoreService() {
		super();
	}

	public void getCore(Catclix0 coreModel) throws ServiceException {
	...
	public List<Catclix0> getCoreList(final Catclix0 coreModel) throws ServiceException {

		Map<String, String> inputFields = coreModel.auxGetSearchFields();

		List<Catclix0> list = new ArrayList<>();
	...
	public void insertCore(Catclix0 coreModel) throws ServiceException {
		// Preparar input fields
	...
	public void updateCore(Catclix0 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetTransactionFields();
	...
	public void deleteCore(Catclix0 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetSearchFields();
	...
	public void previousCore(Catclix0 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetSearchFields();
	 ...
	 */
	protected void coreDao_get(Map<String, String> inputFields, Catclix0 coreModel)
...
//        coreModel.setUsuario(coreResponse.get("usuario")); // 2021-02-25 ati: No viene definido  
	...
	protected List<Catclix0> coreDao_getList(Map<String, String> inputFields, Catclix0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
		...
		List<Catclix0> list = Catclix0.auxGetListFromCore(coreResponse);
	...
	protected void coreDao_insert(Map<String, String> inputFields, Catclix0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_update(Map<String, String> inputFields, Catclix0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_delete(Map<String, String> inputFields, Catclix0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_previous(Map<String, String> inputFields, Catclix0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
		Map<String, String> coreResponse = coreDaoSabe.execute(CORE_SYSTEM, CORE_PROGRAM, CORE_PROGRAM_VERSION,
