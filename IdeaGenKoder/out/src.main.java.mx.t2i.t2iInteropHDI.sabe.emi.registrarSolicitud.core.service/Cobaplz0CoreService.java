...
import mx.t2i.t2iInteropHDI.sabe.emi.registrarSolicitud.core.model.Cobaplz0;
...
/**
 * Despachador (Dispatcher) del servicio para Cobaplz0CoreService
 */
@Service
public class Cobaplz0CoreService {
	private static final Logger log = LoggerFactory.getLogger(Cobaplz0CoreService.class);
	...
	public static final String CORE_PROGRAM = "COBAPLZ0"; // Es el programa de enlace, no el de proceso
	 ...
	 * Constructor default
	 */
	public Cobaplz0CoreService() {
		super();
	}

	public void getCore(Cobaplz0 coreModel) throws ServiceException {
	...
	public List<Cobaplz0> getCoreList(final Cobaplz0 coreModel) throws ServiceException {

		Map<String, String> inputFields = coreModel.auxGetSearchFields();

		List<Cobaplz0> list = new ArrayList<>();
	...
	public void insertCore(Cobaplz0 coreModel) throws ServiceException {
		// Preparar input fields
	...
	public void updateCore(Cobaplz0 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetTransactionFields();
	...
	public void deleteCore(Cobaplz0 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetSearchFields();
	...
	public void previousCore(Cobaplz0 coreModel) throws ServiceException {
		// Preparar input fields
		Map<String, String> inputFields = coreModel.auxGetSearchFields();
	 ...
	 */
	protected void coreDao_get(Map<String, String> inputFields, Cobaplz0 coreModel)
...
//        coreModel.setUsuario(coreResponse.get("usuario")); // 2021-02-25 ati: No viene definido  
	...
	protected List<Cobaplz0> coreDao_getList(Map<String, String> inputFields, Cobaplz0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
		...
		List<Cobaplz0> list = Cobaplz0.auxGetListFromCore(coreResponse);
	...
	protected void coreDao_insert(Map<String, String> inputFields, Cobaplz0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_update(Map<String, String> inputFields, Cobaplz0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_delete(Map<String, String> inputFields, Cobaplz0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
	...
	protected void coreDao_previous(Map<String, String> inputFields, Cobaplz0 coreModel)
			throws ObjectRetrievalFailureException, Exception {
		Map<String, String> coreResponse = coreDaoSabe.execute(CORE_SYSTEM, CORE_PROGRAM, CORE_PROGRAM_VERSION,
