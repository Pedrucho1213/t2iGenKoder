...
/**
 * Despachador (Dispatcher) del servicio para Polgmcc0
 */
@Service
public class Polgmcc0CoreService {
	private static final Logger log = LoggerFactory.getLogger(Polgmcc0CoreService.class);
	...
	public static final String CORE_PROGRAM = "POLGMCY0"; // Es el programa de enlace, no el de proceso
